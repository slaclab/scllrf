...
/** Constructor for the scllrfCMOC class.
 ...
 *
 * */
scllrfCMOC::scllrfCMOC(const char *drvPortName, const char *netPortName)
		...
		newWaveAvailable_(0), newWaveRead_ (0), p_RunStop (stop)
{
    ...
    createParam(Cav4MechNoiseCplKOutString, asynParamInt32Array, &p_Cav4MechNoiseCplKOut);
    createParam(Cav4MechPiezoCplKOutString, asynParamInt32Array, &p_Cav4MechPiezoCplKOut);
    ...
    createParam(Cav4MechPrngRandomRunString, asynParamInt32, &p_Cav4MechPrngRandomRun);
    createParam(Cav4MechResonatorPropConstString, asynParamInt32Array, &p_Cav4MechResonatorPropConst);
    ...
    createParam(StaCav4ElecDot0KOutString, asynParamInt32Array, &p_StaCav4ElecDot0KOut);
    createParam(StaCav4ElecDot1KOutString, asynParamInt32Array, &p_StaCav4ElecDot1KOut);
    createParam(StaCav4ElecDot2KOutString, asynParamInt32Array, &p_StaCav4ElecDot2KOut);
    createParam(StaCav4ElecDrvCplOutCplngString, asynParamInt32, &p_StaCav4ElecDrvCplOutCplng);
    createParam(StaCav4ElecDrvCplOutPhOffString, asynParamInt32, &p_StaCav4ElecDrvCplOutPhOff);
    createParam(StaCav4ElecFreq0CoarseFreqString, asynParamInt32, &p_StaCav4ElecFreq0CoarseFreq);
    createParam(StaCav4ElecFreq1CoarseFreqString, asynParamInt32, &p_StaCav4ElecFreq1CoarseFreq);
    createParam(StaCav4ElecFreq2CoarseFreqString, asynParamInt32, &p_StaCav4ElecFreq2CoarseFreq);
    createParam(StaCav4ElecMode0BeamCplString, asynParamInt32, &p_StaCav4ElecMode0BeamCpl);
    createParam(StaCav4ElecMode0BwString, asynParamInt32, &p_StaCav4ElecMode0Bw);
    createParam(StaCav4ElecMode0DrvCplString, asynParamInt32, &p_StaCav4ElecMode0DrvCpl);
    createParam(StaCav4ElecMode0OutCplOutCplngString, asynParamInt32Array, &p_StaCav4ElecMode0OutCplOutCplng);
    createParam(StaCav4ElecMode0OutCplOutPhOffString, asynParamInt32, &p_StaCav4ElecMode0OutCplOutPhOff);
    createParam(StaCav4ElecMode1BeamCplString, asynParamInt32, &p_StaCav4ElecMode1BeamCpl);
    createParam(StaCav4ElecMode1BwString, asynParamInt32, &p_StaCav4ElecMode1Bw);
    createParam(StaCav4ElecMode1DrvCplString, asynParamInt32, &p_StaCav4ElecMode1DrvCpl);
    createParam(StaCav4ElecMode1OutCplOutCplngString, asynParamInt32, &p_StaCav4ElecMode1OutCplOutCplng);
    createParam(StaCav4ElecMode1OutCplOutPhOffString, asynParamInt32, &p_StaCav4ElecMode1OutCplOutPhOff);
    createParam(StaCav4ElecMode2BeamCplString, asynParamInt32, &p_StaCav4ElecMode2BeamCpl);
    createParam(StaCav4ElecMode2BwString, asynParamInt32, &p_StaCav4ElecMode2Bw);
    createParam(StaCav4ElecMode2DrvCplString, asynParamInt32, &p_StaCav4ElecMode2DrvCpl);
    createParam(StaCav4ElecMode2OutCplOutCplngString, asynParamInt32, &p_StaCav4ElecMode2OutCplOutCplng);
    createParam(StaCav4ElecMode2OutCplOutPhOffString, asynParamInt32, &p_StaCav4ElecMode2OutCplOutPhOff);
    createParam(StaCav4ElecModuloString, asynParamInt32, &p_StaCav4ElecModulo);
    createParam(StaCav4ElecOuterProd0KOutString, asynParamInt32Array, &p_StaCav4ElecOuterProd0KOut);
    createParam(StaCav4ElecOuterProd1KOutString, asynParamInt32Array, &p_StaCav4ElecOuterProd1KOut);
    createParam(StaCav4ElecOuterProd2KOutString, asynParamInt32Array, &p_StaCav4ElecOuterProd2KOut);
    createParam(StaCav4ElecPhaseStepString, asynParamInt32, &p_StaCav4ElecPhaseStep);
		...
		FpgaReg *pToFpga)
{
    ...
    {
		pToFpga->addr = StaCav4ElecMode1OutCplOutPhOffAdr;
    }
    ...
    {
		pToFpga->addr = StaPrngRandomRunAdr;
    }
    else
    	status = asynError;
...
asynStatus scllrfCMOC::writeInt32(asynUser *pasynUser, epicsInt32 value)
{
...
asynStatus scllrfCMOC::writeInt32Array(asynUser *pasynUser, epicsInt32 *value,
                                size_t nElements)
{
	int function = pasynUser->reason;
	asynStatus status = asynSuccess;
...
{
	scllrfCMOC *pscllrfDriver = (scllrfCMOC*)drvPvt;
...
asynStatus scllrfCMOC::startPoller(double pollPeriod)
{
...
void scllrfCMOC::regSettingsInit() {
	epicsEventWaitStatus status;

	printf("%s: exiting\n", __PRETTY_FUNCTION__);
}

void scllrfCMOC::regPoller()
{
	epicsEventWaitStatus status;
    int runStop;
	...
	// A canned request to set all registers to default values
	static FpgaReg cmocWriteAllRegMsgA[88] =
	{
		{ 0, 0 },
		{ 0x0000, 4294967196 },
		{ 0x0001, 4294967196 },
	...
	htonFpgaRegArray(cmocWriteAllRegMsgA, 88);

		static FpgaReg cmocWriteAllRegMsgB[89] =
		{
			{ 0, 0 },
		{ 0x5004, 0 },
		{ 0x5005, 0 },
	...
	htonFpgaRegArray(cmocWriteAllRegMsgB, 89);
	...
	while(1) {
		...
		sendRegRequest(cmocWriteAllRegMsgA, 88);
		sendRegRequest(cmocWriteAllRegMsgB, 89);
		////XXXX
...
asynStatus scllrfCMOC::wakeupPoller()
{
	epicsEventSignal(pollEventId_);
	return asynSuccess;
}
 ...
 **  */
asynStatus scllrfCMOC::sendRegRequest(FpgaReg *regBuffer, unsigned int regBuffCount)
{
 ...
 ** but are free to re-implement it if necessary.
 ** \param[in] pollPeriod The time between polls. */
asynStatus scllrfCMOC::startWaveformRequester()
{
...
void scllrfCMOC::waveformRequester()
{
	epicsEventWaitStatus status;
	//	unsigned int regNum;
 ...
 ** but are free to re-implement it if necessary.
 ** \param[in] pollPeriod The time between polls. */
asynStatus scllrfCMOC::startResponseHandler()
{
...
asynStatus scllrfCMOC::wakeupReader()
{
	epicsEventSignal(readEventId_);
	return asynSuccess;
}

void scllrfCMOC::responseHandler()
{
	asynStatus status;
...
asynStatus scllrfCMOC::processReadbackBuffer(FpgaReg *pRegReadback, unsigned int readCount)
{
	unsigned i;
...
asynStatus scllrfCMOC::catGitSHA1()
{
	int oneByte;
	int i;
	asynStatus status;
...
*/
asynStatus scllrfCMOC::processRegReadback(const FpgaReg *pFromFpga, bool &waveIsReady)
{
	unsigned int i;
	asynStatus status = asynSuccess;
	epicsInt32 errorCount;
	...
	case MagicAdr | flagReadMask:
		...
		asynPrint(pOctetAsynUser_, ASYN_TRACEIO_DRIVER,
				...
				__PRETTY_FUNCTION__, MagicString,
				(unsigned ) pFromFpga->data & MagicMask);
...
* \param[in] waveIsReady A flag that gets set to true if the appropriate bit was set by the FPGA
*/
asynStatus scllrfCMOC::processRegWriteResponse(const FpgaReg *pFromFpga)
{
	asynStatus status = asynSuccess;
...
//	unsigned int i;
    ...
    case DspChanKeepAdr:
		...
		setIntegerParam(p_DspChanKeep, pFromFpga->data);
		printf("CMOC:%s %d\n", DspChanKeepString, pFromFpga->data);
    ...
    case DspFdbkCoreCoarseScaleAdr:
		...
		setIntegerParam(p_DspFdbkCoreCoarseScale, pFromFpga->data);
		printf("CMOC:%s %d\n", DspFdbkCoreCoarseScaleString, pFromFpga->data);
    ...
    case DspFdbkCoreMpProcPhOffsetAdr:
		...
		setIntegerParam(p_DspFdbkCoreMpProcPhOffset, pFromFpga->data);
		printf("CMOC:%s %d\n", DspFdbkCoreMpProcPhOffsetString, pFromFpga->data);
    ...
    case DspFdbkCoreMpProcSelEnAdr:
		...
		setIntegerParam(p_DspFdbkCoreMpProcSelEn, pFromFpga->data);
		printf("CMOC:%s %d\n", DspFdbkCoreMpProcSelEnString, pFromFpga->data);
    ...
    case DspFdbkCoreMpProcSelThreshAdr:
		...
		setIntegerParam(p_DspFdbkCoreMpProcSelThresh, pFromFpga->data);
		printf("CMOC:%s %d\n", DspFdbkCoreMpProcSelThreshString, pFromFpga->data);
    ...
    case DspModuloAdr:
		...
		setIntegerParam(p_DspModulo, pFromFpga->data);
		printf("CMOC:%s %d\n", DspModuloString, pFromFpga->data);
    ...
    case DspPhaseStepAdr:
		...
		setIntegerParam(p_DspPhaseStep, pFromFpga->data);
		printf("CMOC:%s %d\n", DspPhaseStepString, pFromFpga->data);
    ...
    case DspPiezoPiezoDcAdr:
		...
		setIntegerParam(p_DspPiezoPiezoDc, pFromFpga->data);
		printf("CMOC:%s %d\n", DspPiezoPiezoDcString, pFromFpga->data);
    ...
    case DspTagAdr:
		...
		setIntegerParam(p_DspTag, pFromFpga->data);
		printf("CMOC:%s %d\n", DspTagString, pFromFpga->data);
    ...
    case DspWaveSampPerAdr:
		...
		setIntegerParam(p_DspWaveSampPer, pFromFpga->data);
		printf("CMOC:%s %d\n", DspWaveSampPerString, pFromFpga->data);
    ...
    case DspWaveShiftAdr:
		...
		setIntegerParam(p_DspWaveShift, pFromFpga->data);
		printf("CMOC:%s %d\n", DspWaveShiftString, pFromFpga->data);
    ...
    case StaCav4ElecDrvCplOutCplngAdr:
		...
		setIntegerParam(p_StaCav4ElecDrvCplOutCplng, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecDrvCplOutCplngString, pFromFpga->data);
    ...
    case StaCav4ElecDrvCplOutPhOffAdr:
		...
		setIntegerParam(p_StaCav4ElecDrvCplOutPhOff, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecDrvCplOutPhOffString, pFromFpga->data);
    ...
    case StaCav4ElecMode0OutCplOutPhOffAdr:
		...
		setIntegerParam(p_StaCav4ElecMode0OutCplOutPhOff, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode0OutCplOutPhOffString, pFromFpga->data);

		break;
    case StaCav4ElecMode1OutCplOutPhOffAdr:
		status = (asynStatus) getIntegerParam(p_StaCav4ElecMode1OutCplOutPhOff, valueSet);
		if( (valueSet[0] & StaCav4ElecMode1OutCplOutPhOffMask) == (pFromFpga->data & StaCav4ElecMode1OutCplOutPhOffMask))
			asynPrint(pOctetAsynUser_, ASYN_TRACEIO_DRIVER,
				"%s: readback for address=%s, value=0x%x\n", __PRETTY_FUNCTION__,
				StaCav4ElecMode1OutCplOutPhOffString, (unsigned ) pFromFpga->data & StaCav4ElecMode1OutCplOutPhOffMask);
		else
		{
			asynPrint(pOctetAsynUser_, ASYN_TRACE_ERROR,
				"%s: value sent to %s, value=0x%x, doesn't match echoed value=0x%x\n", __PRETTY_FUNCTION__,
				StaCav4ElecMode1OutCplOutPhOffString, valueSet[0] & StaCav4ElecMode1OutCplOutPhOffMask, (unsigned ) pFromFpga->data & StaCav4ElecMode1OutCplOutPhOffMask);
			status = asynError;
			setParamStatus(p_StaCav4ElecMode1OutCplOutPhOff, status);
			getIntegerParam(p_CommErrorCount, &errorCount);
			setIntegerParam(p_CommErrorCount, ++errorCount);
		}
		setIntegerParam(p_StaCav4ElecMode1OutCplOutPhOff, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode1OutCplOutPhOffString, pFromFpga->data);
    ...
    case StaCav4ElecMode2OutCplOutCplngAdr:
		...
		setIntegerParam(p_StaCav4ElecMode2OutCplOutCplng, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode2OutCplOutCplngString, pFromFpga->data);
    ...
    case StaCav4ElecMode2OutCplOutPhOffAdr:
		...
		setIntegerParam(p_StaCav4ElecMode2OutCplOutPhOff, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode2OutCplOutPhOffString, pFromFpga->data);
    ...
    case BeamModuloAdr:
		...
		setIntegerParam(p_BeamModulo, pFromFpga->data);
		printf("CMOC:%s %d\n", BeamModuloString, pFromFpga->data);
    ...
    case BeamPhaseStepAdr:
		...
		setIntegerParam(p_BeamPhaseStep, pFromFpga->data);
		printf("CMOC:%s %d\n", BeamPhaseStepString, pFromFpga->data);
    ...
    case Cav4MechPrngIvaAdr:
		...
		setIntegerParam(p_Cav4MechPrngIva, pFromFpga->data);
		printf("CMOC:%s %d\n", Cav4MechPrngIvaString, pFromFpga->data);
    ...
    case Cav4MechPrngIvbAdr:
		...
		setIntegerParam(p_Cav4MechPrngIvb, pFromFpga->data);
		printf("CMOC:%s %d\n", Cav4MechPrngIvbString, pFromFpga->data);
    ...
    case Cav4MechPrngRandomRunAdr:
		...
		setIntegerParam(p_Cav4MechPrngRandomRun, pFromFpga->data);
		printf("CMOC:%s %d\n", Cav4MechPrngRandomRunString, pFromFpga->data);
    ...
    case StaACavOffsetAdr:
		...
		setIntegerParam(p_StaACavOffset, pFromFpga->data);
		printf("CMOC:%s %d\n", StaACavOffsetString, pFromFpga->data);
    ...
    case StaAForOffsetAdr:
		...
		setIntegerParam(p_StaAForOffset, pFromFpga->data);
		printf("CMOC:%s %d\n", StaAForOffsetString, pFromFpga->data);
    ...
    case StaARflOffsetAdr:
		...
		setIntegerParam(p_StaARflOffset, pFromFpga->data);
		printf("CMOC:%s %d\n", StaARflOffsetString, pFromFpga->data);
    ...
    case StaAmpLpBwAdr:
		...
		setIntegerParam(p_StaAmpLpBw, pFromFpga->data);
		printf("CMOC:%s %d\n", StaAmpLpBwString, pFromFpga->data);
    ...
    case StaCav4ElecFreq0CoarseFreqAdr:
		...
		setIntegerParam(p_StaCav4ElecFreq0CoarseFreq, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecFreq0CoarseFreqString, pFromFpga->data);
    ...
    case StaCav4ElecFreq1CoarseFreqAdr:
		...
		setIntegerParam(p_StaCav4ElecFreq1CoarseFreq, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecFreq1CoarseFreqString, pFromFpga->data);
    ...
    case StaCav4ElecFreq2CoarseFreqAdr:
		...
		setIntegerParam(p_StaCav4ElecFreq2CoarseFreq, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecFreq2CoarseFreqString, pFromFpga->data);
    ...
    case StaCav4ElecMode0BeamCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode0BeamCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode0BeamCplString, pFromFpga->data);
    ...
    case StaCav4ElecMode0BwAdr:
		...
		setIntegerParam(p_StaCav4ElecMode0Bw, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode0BwString, pFromFpga->data);
    ...
    case StaCav4ElecMode0DrvCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode0DrvCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode0DrvCplString, pFromFpga->data);
    ...
    case StaCav4ElecMode1BeamCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode1BeamCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode1BeamCplString, pFromFpga->data);
    ...
    case StaCav4ElecMode1BwAdr:
		...
		setIntegerParam(p_StaCav4ElecMode1Bw, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode1BwString, pFromFpga->data);
    ...
    case StaCav4ElecMode1DrvCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode1DrvCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode1DrvCplString, pFromFpga->data);
    ...
    case StaCav4ElecMode2BeamCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode2BeamCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode2BeamCplString, pFromFpga->data);
    ...
    case StaCav4ElecMode2BwAdr:
		...
		setIntegerParam(p_StaCav4ElecMode2Bw, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode2BwString, pFromFpga->data);
    ...
    case StaCav4ElecMode2DrvCplAdr:
		...
		setIntegerParam(p_StaCav4ElecMode2DrvCpl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode2DrvCplString, pFromFpga->data);
    ...
    case StaCav4ElecModuloAdr:
		...
		setIntegerParam(p_StaCav4ElecModulo, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecModuloString, pFromFpga->data);
    ...
    case StaCav4ElecPhaseStepAdr:
		...
		setIntegerParam(p_StaCav4ElecPhaseStep, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecPhaseStepString, pFromFpga->data);
    ...
    case StaComprSatCtlAdr:
		...
		setIntegerParam(p_StaComprSatCtl, pFromFpga->data);
		printf("CMOC:%s %d\n", StaComprSatCtlString, pFromFpga->data);
    ...
    case StaPrngIvaAdr:
		...
		setIntegerParam(p_StaPrngIva, pFromFpga->data);
		printf("CMOC:%s %d\n", StaPrngIvaString, pFromFpga->data);
    ...
    case StaPrngIvbAdr:
		...
		setIntegerParam(p_StaPrngIvb, pFromFpga->data);
		printf("CMOC:%s %d\n", StaPrngIvbString, pFromFpga->data);

		break;
    case StaPrngRandomRunAdr:
		status = (asynStatus) getIntegerParam(p_StaPrngRandomRun, valueSet);
		if( (valueSet[0] & StaPrngRandomRunMask) == (pFromFpga->data & StaPrngRandomRunMask))
			asynPrint(pOctetAsynUser_, ASYN_TRACEIO_DRIVER,
				"%s: readback for address=%s, value=0x%x\n", __PRETTY_FUNCTION__,
				StaPrngRandomRunString, (unsigned ) pFromFpga->data & StaPrngRandomRunMask);
		else
		{
			asynPrint(pOctetAsynUser_, ASYN_TRACE_ERROR,
				"%s: value sent to %s, value=0x%x, doesn't match echoed value=0x%x\n", __PRETTY_FUNCTION__,
				StaPrngRandomRunString, valueSet[0] & StaPrngRandomRunMask, (unsigned ) pFromFpga->data & StaPrngRandomRunMask);
			status = asynError;
			setParamStatus(p_StaPrngRandomRun, status);
			getIntegerParam(p_CommErrorCount, &errorCount);
			setIntegerParam(p_CommErrorCount, ++errorCount);
		}
		setIntegerParam(p_StaPrngRandomRun, pFromFpga->data);
		printf("CMOC:%s %d\n", StaPrngRandomRunString, pFromFpga->data);
    ...
    case StaCav4ElecMode1OutCplOutCplngAdr:
		...
		setIntegerParam(p_StaCav4ElecMode1OutCplOutCplng, pFromFpga->data);
		printf("CMOC:%s %d\n", StaCav4ElecMode1OutCplOutCplngString, pFromFpga->data);
...
/** EPICS iocsh callable function to call constructor for the scllrfCMOC class.
 * \param[in] portName The name of the asyn port driver to be created.
 * \param[in] netPortName The name of the asynIPport this will use to communicate */
int scllrfCMOCConfigure(const char *drvPortName, const char *netPortName)
{
	new scllrfCMOC(drvPortName, netPortName);
	return asynSuccess;
}
...
static const iocshArg * const initArgs[] = {&initArg0,
		&initArg1};
static const iocshFuncDef initFuncDef = {"scllrfCMOCConfigure",2,initArgs};
static void initCallFunc(const iocshArgBuf *args)
{
	scllrfCMOCConfigure(args[0].sval, args[1].sval);
}

void scllrfCMOCRegister(void)
{
	iocshRegister(&initFuncDef,initCallFunc);
}

epicsExportRegistrar(scllrfCMOCRegister);
