...
#ifndef SCLLRFAPP_SRC_SCLLRFCMOC_H_
#define SCLLRFAPP_SRC_SCLLRFCMOC_H_
...
const char *StaCav4ElecFreq0CoarseFreqString = "STA_CAV4_ELEC_FREQ_0_COARSE_FREQ";
const char *StaCav4ElecFreq1CoarseFreqString = "STA_CAV4_ELEC_FREQ_1_COARSE_FREQ";
const char *StaCav4ElecFreq2CoarseFreqString = "STA_CAV4_ELEC_FREQ_2_COARSE_FREQ";
...
const char *StaCav4ElecMode0OutCplOutCplngString = "STA_CAV4_ELEC_MODE_0_OUT_CPL_OUT_CPLNG";
const char *StaCav4ElecMode0OutCplOutPhOffString = "STA_CAV4_ELEC_MODE_0_OUT_CPL_OUT_PH_OFF";
...
const char *StaCav4ElecMode1OutCplOutCplngString = "STA_CAV4_ELEC_MODE_1_OUT_CPL_OUT_CPLNG";
const char *StaCav4ElecMode1OutCplOutPhOffString = "STA_CAV4_ELEC_MODE_1_OUT_CPL_OUT_PH_OFF";
...
const char *StaCav4ElecMode2OutCplOutCplngString = "STA_CAV4_ELEC_MODE_2_OUT_CPL_OUT_CPLNG";
const char *StaCav4ElecMode2OutCplOutPhOffString = "STA_CAV4_ELEC_MODE_2_OUT_CPL_OUT_PH_OFF";
...
class scllrfCMOC: public scllrfAsynPortDriver
{
public:
	scllrfCMOC(const char *drvPortName, const char *netPortName);
	virtual ~scllrfCMOC();
...
#define FIRST_CMOC_PARAM p_RunStop
    ...
    #define LAST_CMOC_PARAM p_StaPrngRandomRun
...
#endif /* SCLLRFAPP_SRC_SCLLRFCMOC_H_ */
