...
dbLoadRecords("db/RESRegisters.db","P=RES,PORT=resReg")
dbLoadRecords("db/cmocWaveforms.db","P=RES,PORT=resReg")
#
...
# Set up communication with RES

# Echo from cdlx11 configuration for testing
#epicsEnvSet( FPGA_IP, "134.79.216.36")
#drvAsynIPPortConfigure("resIP","$(FPGA_IP):7 UDP")

# Real RES configuration
epicsEnvSet( FPGA_IP, "res_rj")
drvAsynIPPortConfigure("resIP","$(FPGA_IP):50006 UDP")
dbLoadRecords("db/asynRecord.db","P=RES1:CMTS,R=ASYN_IP,PORT=resIP,ADDR=0,IMAX=0,OMAX=0")
...
#epicsThreadSleep(1.0)
scllrfRESConfigure( "resReg","resIP")
dbLoadRecords("db/asynRecord.db","P=RES1:CMTS,R=ASYN_REG,PORT=resReg,ADDR=0,IMAX=0,OMAX=0")
...
asynSetTraceMask("resIP",-1,1)
asynSetTraceMask("resReg",-1,1)
