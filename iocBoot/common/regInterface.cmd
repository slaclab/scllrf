...
dbLoadRecords("db/asynRecord.db","P=$(P),R=ASYN_IP,PORT=resIP,ADDR=0,IMAX=0,OMAX=0")


#epicsThreadSleep(1.0)
scllrf$(TYPE)Configure( "myReg","myIP")
dbLoadRecords("db/asynRecord.db","P=$(P),R=ASYN_REG,PORT=resReg,ADDR=0,IMAX=0,OMAX=0")
